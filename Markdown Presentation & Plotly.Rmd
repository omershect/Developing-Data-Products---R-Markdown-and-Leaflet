...
Read 2017 Car crash data of Allegheny County.
```{r}
...
```{r}
dfCrash<-select(DF,DEC_LAT,DEC_LONG,CRASH_MONTH,AUTOMOBILE_COUNT)
colnames(dfCrash)<-c("latitude","longitude","Month Crash","Number Of Cars involved")
